              ...
              {navItems.map((item) => {
                ...
                if (item.isExplore) {
                  return (
                    <button
                      ...
                      className="relative flex flex-col items-center justify-center w-14 h-full focus:outline-none"
                ...
                return (
                  <Link
                    ...
                    className="relative flex flex-col items-center justify-center w-14 h-full focus:outline-none group"
                  >
                    <div
