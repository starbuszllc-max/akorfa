    ...
    >
      ...
      <div className="mt-1 pt-2 border-b border-gray-200 dark:border-slate-700/50 flex items-center gap-4 pb-3">
        ...
        >
          ...
          <span className={hasLiked ? 'text-red-500' : 'text-gray-700 dark:text-gray-400'}>{localLikeCount}</span>
        </motion.button>

        <motion.button 
          onClick={toggleComments}
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-1.5 text-sm transition-colors text-gray-700 dark:text-gray-400"
        >
        ...
        <motion.button
          onClick={handleShare}
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-1.5 text-sm text-gray-700 dark:text-gray-400"
        >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
